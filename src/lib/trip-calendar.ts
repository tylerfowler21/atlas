/// A trip laid out on a real calendar.
///
/// A row of chips says a trip has four days. It does not say that two of them
/// are a weekend, that the museum day lands on the Monday it is shut, or that
/// the flight home is the morning after a bank holiday. Those are the things
/// people are actually checking when they ask what day something is on, and a
/// month grid answers all of them at a glance because it is the shape everyone
/// already knows.
///
/// Dates are UTC midnight throughout, as everywhere else that touches a trip:
/// a date picker gives a date, not an instant, and reading these locally would
/// slide a day either side of midnight for half the world.
