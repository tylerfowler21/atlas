/// The brand kit's raw values — the one place a colour is written down.
///
/// Taken from the Figma foundations board. The screen boards carry the same
/// colours a shade or two off in places (Ink appears as both #13241F and
/// #12241F, Sun as #F98746 and #FA8745), which is what happens when swatches
/// are picked per-artboard rather than bound to variables. The foundations
/// board wins; everything here is its value.
///
/// These are raw paint. What a colour is *for* lives in the palettes below and
/// in the website's CSS variables — nothing outside those should reach for a
/// name from this list, or the roles stop meaning anything.
export const PAINT = {
  evergreen900: "#12322B",
  evergreen700: "#245247",
  evergreen100: "#E4EDE8",
