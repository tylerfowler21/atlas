/// Mirrored from the website's src/lib/booking-deadline.ts — edit that copy
/// and run `npm run sync-mirror`. A deadline should read the same on both, and
/// "2 days overdue" is not a thing to phrase twice.
