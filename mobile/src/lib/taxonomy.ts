...
const BY_TYPE: Record<string, BuiltInCategoryId> = {
  ...
  // These are the ones that kept falling through to Other: a lake is not an
  // "other", and neither is a bookshop, a cable car or a swimming pool.
  canteen: "restaurant",
  barbecue: "restaurant",
  patisserie: "cafe",
  chocolate: "cafe",
