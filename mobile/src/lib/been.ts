/// Mirrored from the website's src/lib/been.ts — edit that copy and run
/// `npm run sync:mirror`. How many countries you have been to is the one
/// number people repeat about themselves; it cannot differ by screen.
