/// Mirrored from the website's src/lib/map-view.ts — edit that copy and run
/// `npm run sync:mirror`. The map's heading should name the same stretch of
/// world on both clients.
export type Bounds = {
  north: number;
  south: number;
  east: number;
