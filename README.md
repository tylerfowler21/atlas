...
| `AUTH_APPLE_SECRET` | A **JWT** signed with a `.p8` key, generated by `npm run apple:secret` |
...
weeks and `/admin` shows the expiry date. Regenerate with `npm run apple:secret`.
